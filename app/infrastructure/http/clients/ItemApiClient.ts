import type {
  IItemListParams,
  IItemDetailParams,
  ItemRecommendationCheckoutAddParams,
...
export class ItemApiClient {
   ...
   * 结算页推荐商品加购并重算
   */
  async checkoutAddRecommendation(params: ItemRecommendationCheckoutAddParams): Promise<any> {
    return this.http('/wxapp/goods/recommendations/checkout-add', {
      method: 'POST',
      body: params,
      useJson: true,
