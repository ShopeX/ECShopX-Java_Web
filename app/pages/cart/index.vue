<template>
  <div class="min-h-screen bg-white">
    <!-- 页面标题 - 根据 Figma 设计 -->
    <div
      class="content-stretch flex items-center px-[16px] lg:mx-auto lg:max-w-[1680px] lg:px-[120px] py-[16px] relative w-full"
    >
    ...
    <!-- 购物车内容 -->
    <div
      class="px-[16px] lg:mx-auto lg:max-w-[1680px] lg:px-[120px] pt-[32px] pb-0 lg:pb-[64px] bg-white flex flex-col min-h-[calc(100vh-80px)]"
    >
      <!-- 加载状态：首次加载或正在加载 -->
      ...
      <div
        v-else
        class="content-stretch flex flex-col lg:flex-row gap-[32px] lg:gap-[80px] items-start justify-center flex-1"
      >
        <!-- 左侧：商品列表容器 -->
        <div
...
const { products: recommendedProducts, visible: recommendationsVisible } = useProductRecommendations({
  ...
  enabled: computed(() => initialized.value && cartMainItemIds.value.length > 0),
})
