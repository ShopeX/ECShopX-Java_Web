            ...
            <div class="relative shrink-0 w-full">
              ...
              >
                ...
                >
                  ...
                  <button
                    type="button"
                    class="flex flex-col items-center gap-1 text-[#4a5565] hover:text-[#191a1d]"
                    data-testid="account-signin-entry"
                    @click="goSignIn"
                  >
                    <span
                      class="flex h-10 w-10 items-center justify-center rounded-full bg-[#fff7e6] text-[#e8a317] text-[18px]"
                      aria-hidden="true"
                      >✓</span
                    >
                    <span class="text-[12px] leading-4">{{ t('a8f9884.entry') }}</span>
                  </button>
                  -->
                </div>
              </div>
          ...
          <div class="w-full">
            ...
            >
              <div class="flex gap-4 items-center justify-between w-full">
                ...
                <button
                  type="button"
                  class="flex flex-col items-center gap-1 text-[#4a5565]"
                  data-testid="account-signin-entry-h5"
                  @click="goSignIn"
                >
                  <span
                    class="flex h-9 w-9 items-center justify-center rounded-full bg-[#fff7e6] text-[#e8a317]"
                    aria-hidden="true"
                    >✓</span
                  >
                  <span class="text-[12px]">{{ t('a8f9884.entry') }}</span>
                </button>
                -->
              </div>
            </div>
...
// 临时隐藏签到入口，后续放开
// function goSignIn() {
//   router.push(localePath('/account/sign-in'))
// }
