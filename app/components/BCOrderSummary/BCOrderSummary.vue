<template>
  <div
    class="bg-white content-stretch flex flex-col items-start relative shrink-0 w-full lg:w-[380px]"
  >
    <div class="relative shrink-0 w-full lg:w-[380px]">
      <div
      ...
      >
        <div
          class="content-stretch flex flex-col gap-[16px] items-start relative shrink-0 w-full lg:w-[380px]"
        >
          <!-- 商品数量 -->
          <div class="relative shrink-0 w-full lg:w-[380px]">
            <div
          ...
          <!-- 优惠 -->
          <div v-if="discountAmount > 0" class="relative shrink-0 w-full lg:w-[380px]">
            <div
              class="bg-clip-padding border-0 border-transparent border-solid content-stretch flex items-center justify-between relative w-full"
            >
              <div class="h-[20px] relative shrink-0">
          ...
          <!-- 分割线 -->
          <div class="bg-[rgba(0,0,0,0.1)] h-px shrink-0 w-full lg:w-[380px]" />
