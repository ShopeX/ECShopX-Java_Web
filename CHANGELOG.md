...
## [5.1.0](https://ms-git.ishopex.cn/ecshopx/ecshopx-web/compare/v5.0.0...v5.1.0) (2026-09-24)
...
* **decoration:** enhance ImageHotspot and ProductTabShelf components with batch item loading and improved image handling ([e4834eb](https://ms-git.ishopex.cn/ecshopx/ecshopx-web/commit/e4834eb7c2587d19013b81fde2677ae7d8dfcd73))
...
* **docker:** add Dockerfile for Atlas application setup with Node.js environment ([f735b00](https://ms-git.ishopex.cn/ecshopx/ecshopx-web/commit/f735b008bc2328740eb937000c1ca21e12daa5cb))
